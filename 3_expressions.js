...
This happens because JavaScript uses floating-point arithmetic, which is based on the IEEE 754 standard for 64-bit binary floating-point numbers.

🔹 Key Issue:

    Decimals like 0.1 and 0.2 cannot be exactly represented in binary.
    Their binary equivalents introduce small rounding errors.
    When 0.1 and 0.2 are added, the result is slightly off from 0.3.
=================================== */
